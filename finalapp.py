...
selected_books = st.selectbox(
    "Select a book you like from the menu below",
    book_names
)

if st.button('Show Recommendation'):
    recommended_books,poster_url = recommend_book(selected_books)
    st.write(f"Since you like {selected_books}, you may also like:")
    ...
    with col2:
        ...
        st.write(recommended_books[2])

    with col3:
        st.image(poster_url[3])
        st.write(recommended_books[3])
    with col4:
        st.image(poster_url[4])
        st.write(recommended_books[4])
    with col5:
        st.image(poster_url[5])
        st.write(recommended_books[5])